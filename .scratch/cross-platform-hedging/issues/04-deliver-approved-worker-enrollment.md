...
- [x] Pending registration is rate-limited per Cloudflare client IP, expires after 15 minutes, cannot be reactivated after rejection, atomically leaves pending before credential cleanup, and retries failed OpenBao password-secret deletion when rejected or expired.
