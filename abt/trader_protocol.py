"""Shared, validated wire models for Pair Execution Cell relay and MT5 receipts."""
...
class BrokerReceipt(_ProtocolModel):
    """The validated shape of one MT5 broker receipt, shared by live receipt handling."""
...
class PairRouteClaim(_ProtocolModel):
    ...
    in an ownership record, and not in a controller API.
